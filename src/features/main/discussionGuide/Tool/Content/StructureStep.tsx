...
import DraggableItem from "../../../../../components/layouts/DraggableItem";
import DiscussionGuideDrawer from "./DiscussionGuideDrawer";
...
const typeItemsMap: { [key: string]: DraggableItemProps[] } = {
  "Patient Journey": [
    { title: "Background & Introduction", id: 1 },
    { title: "Discussion Flow", id: 2 },
    { title: "Market Research Disclosures", id: 3 },
    { title: "Discussion Topics", id: 4 },
  ],
  "Market Assessment": [
    { title: "Background & Introduction", id: 1 },
    { title: "Discussion Flow", id: 2 },
  ...
  "Focus Group": [
    { title: "Discussion Flow", id: 1 },
    { title: "Background & Introduction", id: 2 },
    { title: "Market Research Disclosures", id: 3 },
    { title: "Discussion Topics", id: 4 },
  ],
};

const StructureStep = ({ selectedType }: StructureStepProps) => {
  ...
  return (
    <Box sx={{ display: "flex", gap: "16px", padding: "20px 20px 0 20px" }}>
      <>
        {isLoading ? (
