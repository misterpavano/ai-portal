...
import { GeneralMeetingNotesSectionKey } from "../../../../../types/meetingNotesTypes";

interface RegenerateModalProps {
  open: boolean;
  onClose: () => void;
  anchorEl: HTMLElement | null;
  sectionKey: GeneralMeetingNotesSectionKey | null;
  onRegenerate: (note: string) => void;
}

const RegenerateGeneralMeetingNotesModal: React.FC<RegenerateModalProps> = ({
  open,
  onClose,
  anchorEl,
  sectionKey,
  ...
  const [notes, setNotes] = useState<
    Record<GeneralMeetingNotesSectionKey, string>
  >({} as Record<GeneralMeetingNotesSectionKey, string>);
...
export default RegenerateGeneralMeetingNotesModal;
