...
import { DetailedInsightsFormValues } from "../../../../../types/interviewSummaries";
...
export type DetailedInsightsProps = {
  initialValues: DetailedInsightsFormValues;
  handleSubmit: (formValues: DetailedInsightsFormValues) => void;
};

const DetailedInsightsForm: React.FC<DetailedInsightsProps> = ({
  initialValues,
  handleSubmit,
}) => {
  ...
  const [initialFormValues, setFormInitialValues] = useState(
    interviewSummariesFormValues.detailedInsights
  );
...
export default DetailedInsightsForm;
