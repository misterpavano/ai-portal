...
import { KeyTakeawaysFormValues } from "../../../../../types/interviewSummaries";
...
export type KeyTakeawaysProps = {
  initialValues: KeyTakeawaysFormValues;
  handleSubmit: (formValues: KeyTakeawaysFormValues) => void;
};

const KeyTakeawaysForm: React.FC<KeyTakeawaysProps> = ({
  initialValues,
  handleSubmit,
}) => {
  ...
  const [initialFormValues, setFormInitialValues] = useState(
    interviewSummariesFormValues.keyTakeaways
  );
...
export default KeyTakeawaysForm;
