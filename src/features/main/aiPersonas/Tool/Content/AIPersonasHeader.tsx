...
interface AIPersonasHeaderProps {
  clientName: string;
}

const AIPersonasHeader = ({ clientName }: AIPersonasHeaderProps) => {
          ...
          >
            <Box>
              <Typography style={{ fontWeight: 400, fontSize: "16px" }}>
                <b>AI Personas</b> / {clientName.replace(/_/g, " ")}
              </Typography>
            </Box>
            <Box
              sx={{
...
export default AIPersonasHeader;
